...
#ตอนนี้ใช้งานได้แค่ + - x / AC = M MR ครับ อาจมีการเปลี่ยนแปลงแบบแผนใหม่ในอนาคต
...
class MainWindow(QMainWindow, Ui_Calculator):
    def __init__(self, *args, **kwargs):
        ...
        self.MemoryButton.pressed.connect(self.memory_store)
        self.CallMemoButton.pressed.connect(self.memory_recall)
